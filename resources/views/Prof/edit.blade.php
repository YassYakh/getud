    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Modification des prof</div>

                <div class="panel-body">
                    <h2 class="modal-title" style="text-align: center;">Modifier le prof {{$prof->nom}}  </h2>
                        
                      
                      {!! Form::model($prof,array('route'=>['prof.update',$prof->id],'method'=>'PUT'
                  )) !!}
